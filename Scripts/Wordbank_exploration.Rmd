...
## Loading packages
```{r}
pacman::p_load(ggplot2, tidyverse, rethinking)
```
...
## Merging data
```{r}
data_usa <- merge(longitudinal_usa, childdata_usa, by = "child_id")
```
...
data_usa <- subset(data_usa, select = -c(downloaded.x, downloaded.y, age.y, is_norming, ethnicity, race, birth_weight, born_early_or_late, gestational_age, zygosity, language_exposures, health_conditions, monolingual, typically_developing, value))
