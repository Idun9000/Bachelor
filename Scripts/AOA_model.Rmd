...
posterior_predictive <- posterior_predict(AOA_model, newdata = merged_AOA_test) # matrix where each row corresponds to a prediction for an observation in the test set, and each column corresponds to a draw from the posterior distribution of the predicted probabilities
