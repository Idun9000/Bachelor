...
# Setting priors
```{r}
#get_prior(formula, data = Centrality_DF_t2)
model_priors <- c(
...
# Kfold child model 1 - strat
```{r}
kfold_child_model_1_strat <- brms::kfold(Child_model_1, K = 5, folds = "stratify", group = "Child_ID")
#saveRDS(kfold_child_model_1_strat, "../Models/kfold_child_model_1_strat.rds")
...
# Kfold child model 2
```{r}
#kfold_child_model_2 <-  brms::kfold(Child_model_2, K = 5)
...
```{r}
# kfold_global_model_2 <- brms::kfold(Global_model_2, K = 5)
