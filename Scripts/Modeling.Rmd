...
#              file = "../Models/Child_specific_training.rds"
#              ) 
...
Child_specific_model <- readRDS("../Models/Child_specific_training.rds")
```
...
Child_specific_model_k <- readRDS("../Models/Child_specific_kfold.rds")
```
...
#              threads = threading(2),
#              stan_model_args = list(stanc_options = list("O1")),
#              file = "../Models/Child_specific_age_training.rds"
#              )

Child_specific_model_with_age <- readRDS("../Models/Child_specific_age_training.rds")
```
...
#              threads = threading(2),
#              stan_model_args = list(stanc_options = list("O1")),
#              file = "../Models/Child_specific_age_kfold.rds"
#              )

Child_specific_model_with_age_k <- readRDS("../Models/Child_specific_age_kfold.rds")
```
...
#              threads = threading(2),
#              stan_model_args = list(stanc_options = list("O1")),
#              file = "../Models/Child_specific_only_age.rds"
#              )

Child_specific_model_only_age <- readRDS("../Models/Child_specific_only_age.rds")
```
...
Child_specific_model_only_age_k <- readRDS("../Models/Child_specific_only_age_kfold.rds")
```
...
#saveRDS(k_fold_child_specific_age, "../Models/kfold_Child_Specific_with_age.rds")
