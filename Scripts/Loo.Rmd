...
pp_check(Child_model, nsamples = 100)
...
mean_predicts_child <- sapply(1:length(predictions_list), function(i) {
...
mean_predicts <- sapply(1:length(predictions_list), function(i) {
  mean(predictions_list[, i])
})
